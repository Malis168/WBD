			        ...
			        <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="property_type-list-tab">
						...
						<?php 
						 	if(isset($_POST['btnDelete']))
							{
								...
								if(mysqli_query($conn, $sql)){
									echo msg_style('Data Delete success!','success');
								}else{
									echo msg_style('Data Delete UNsuccess!','info');
								}
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											...
											<tr>
												...
												<td class="cell">
													<button type="button" class="btn btn-info" href="#"><i class="fa-solid fa-eye"></i></button>
													...
													<button type="submit" id="id" name="btnDelete" onclick="return confirm('Are you sure to delete it?')" class="btn btn-danger" href="#"><i class="fa-solid fa-trash-can"></i></button>											
												</td>
											</tr>
										<?php
											$i++;
						...
						?>  
						   <div class="app-card-body">
								...
								<div class="mb-3">
									...
									<div class="mb-3">
										<label for="setting-input-3" class="form-label">បរិយាយ</label>
										<input type="text" class="form-control" name="tar_desc" id="tar_desc" value="">
								</div>
